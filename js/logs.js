...
function filtrarLogs() {
    ...
    cards.forEach(card => {
        ...
        const categoriaCard = card.querySelector(".informacoes")?.textContent.toLowerCase() || "";

        const statusCard = card.querySelector(".status")?.textContent.toLowerCase() || "";
